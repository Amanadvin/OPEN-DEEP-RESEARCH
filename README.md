...
The following screenshot shows a sample normal-based response generated by the system.

![NORMAL- SEARCH ]( https://github.com/Amanadvin/OPEN-DEEP-RESEARCH/blob/main/Normal-search.png)
### Chat Output – Example 2

The following screenshot shows a follow-up question handled using  research-paper.

![RESEARCH- PAPER ](https://github.com/Amanadvin/OPEN-DEEP-RESEARCH/blob/main/Research_%20paper.png)

The following screenshot shows a follow-up question handled using  hybrid search .

![hybrid- search ]( https://github.com/Amanadvin/OPEN-DEEP-RESEARCH/blob/main/hybrid_search.png)
